...
static const BlurConfig s_presets[] = {
    // id       display       σ     sat   bright  ovlOp  ovlColor   vig   grain  frameEn  frameW   γ     warm  lift
    { "default", "Default", WalltzDefaults::blurRadius, WalltzDefaults::saturationFactor, WalltzDefaults::blurBrightness, WalltzDefaults::overlayOpacity, 0x000000, WalltzDefaults::vignetteStrength, WalltzDefaults::grainStrength, false, 0,  1.0,  0.0,  0.0 },
    { "auto",    "Auto",      0.0,   1.0,  1.00,   0.0,   0x000000,  0.0,  0.0,  false, 0,  1.0,  0.0,  0.0 },
    { "serenity","Serenity", 25,    0.30,  0.65,   0.55,  0x181824,  0.15,  0.0,  false, 0,  1.0,  0.0,  0.0 },
    { "focus",   "Focus",     8,    0.55,  0.90,   0.15,  0x1c1c1c,  0.0,  0.0,  false, 0,  1.0,  0.0,  0.0 },
    { "comfort", "Comfort",  20,    0.80,  0.78,   0.35,  0x2a1f14,  0.25,  0.02, false, 0,  1.0,  0.0,  0.0 },
    { "apple",   "Apple",   30,    1.8,  1.02,   0.50,  0x1a1a1a,  0.0,  0.0,  false, 0,  1.0,  0.0,  0.0 },
    { "gnome",   "GNOME",   30,    1.0,  0.60,   0.0,   0x000000,  0.0,  0.0,  false, 0,  1.0,  0.0,  0.0 },
    { "mica",    "Mica",    10,    0.9,  0.85,   0.30,  0x323232,  0.0,  0.0,  false, 0,  1.0,  0.0,  0.0 },
    { "acrylic", "Acrylic", 30,    1.0,  0.90,   0.60,  0x202020,  0.0,  0.03, false, 0,  1.0,  0.0,  0.0 },
